    ...
    if (menu_visible) {
        ...
        ImGui::BeginTabBar("Menu Tabs");
                    if (ImGui::BeginTabItem("ESP")) {
                        if (ImGui::Checkbox("Box", &esp_enabled)) {
                            SaveConfig();
                        }
                        if (ImGui::Checkbox("Line", &line_enabled)) {
                            SaveConfig();
                        }
                        if (ImGui::Checkbox("Enemies", &enemies_counter_enabled)) {
                            SaveConfig();
                        }
                        ImGui::EndTabItem();
                    }
                    if (ImGui::BeginTabItem("Settings")) {
                        ...
                        if (ImGui::ColorEdit4("Box Color", (float*)&esp_box_color.Value)) {
                            SaveConfig();
                        }
                        if (ImGui::SliderFloat("Box Thickness", &box_thickness, 1.0f, 3.0f)) {
                        ...
                        if (ImGui::ColorEdit4("Line Color", (float*)&line_color.Value)) {
                            SaveConfig();
                        }
                        if (ImGui::SliderFloat("Line Thickness", &line_thickness, 1.0f, 3.0f)) {
